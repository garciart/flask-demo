...
Usage:
- python -B -m flask --app "v08" run
- python -B -m flask --app "v08:create_app(config_class='v08.config.DevConfig')" run
"""
...
from v08.config import Config, DevConfig, TestConfig  # noqa
...
def create_app(config_class: object = DevConfig) -> flask.Flask:
    ...
    from v08.blueprints.main import main_routes
