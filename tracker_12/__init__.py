...
- python -B -m flask --app "tracker_12:create_app('development', True)" run
...
from tracker_12.app_utils import (validate_input, check_system, start_log_file,
                                  log_page_request)
# Import the runtime configuration classes
from tracker_12.config import Config, DevConfig, ProfilerConfig
