"""A Flask application that incorporates blueprints.
...
Usage: python -B -m flask --app tracker_12 run
"""
...
from tracker_12.app_utils import validate_input, check_system, start_log_file, log_page_request
# Import the runtime configuration classes
from tracker_12.config import CONFIGS
# Import a SQLAlchemy object
from tracker_12.models import db, migrate
# Import profiler middleware
from tracker_12.profiler import add_profiler_middleware
...
def create_app(config_name: str = 'default', log_events: Union[bool, None] = None) -> flask.Flask:
    ...
    from tracker_12.blueprints import main, error, admin
...
def _configure_database(app: flask.Flask) -> flask.Flask:
    ...
    with app.app_context():
        ...
        if not os.path.exists(db_path):
            from tracker_12.models.create_db import create_db
