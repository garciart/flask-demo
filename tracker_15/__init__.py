...
- python -B -m flask --app "tracker_15:create_app('development', True)" run
...
from tracker_15.app_utils import (validate_input, check_system, start_log_file,
                                  log_page_request)
# Import the runtime configuration classes
from tracker_15.config import Config, DevConfig, ProfilerConfig
...
def create_app(config_name: str = 'default', log_events: bool = False) -> flask.Flask:
    ...
    from tracker_15.blueprints import main, error, api, admin
