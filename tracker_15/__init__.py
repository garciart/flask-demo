"""A Flask application that uses an API to update a member.
...
Usage: python -B -m flask --app tracker_15 run
"""
...
from tracker_15.app_utils import validate_input, check_system, start_log_file, log_page_request
# Import the runtime configuration classes
from tracker_15.config import CONFIGS
# Import a SQLAlchemy object
from tracker_15.models import db, migrate
# Import profiler middleware
from tracker_15.profiler import add_profiler_middleware
...
def create_app(config_name: str = 'default', log_events: Union[bool, None] = None) -> flask.Flask:
    ...
    from tracker_15.blueprints import main, error, admin, api
...
def _configure_database(app: flask.Flask) -> flask.Flask:
    ...
    with app.app_context():
        ...
        if not os.path.exists(db_path):
            from tracker_15.models.create_db import create_db
