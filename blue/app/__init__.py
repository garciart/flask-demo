...
import sys
import flask
from app.config import Config, DevConfig, TestConfig
...
def _start_log(app: flask.Flask, logging_level: int = logging.DEBUG) -> None:
    ...
    :return: None
    """
    # Example entry: 2024-07-09 22:08:25,132-app-INFO: Starting Flask application
    # [at repos\blue\app\__init__.py:102]
    _msg_format = (
