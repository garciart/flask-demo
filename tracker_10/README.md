...
# python -B -m flask --app tracker_10 db init --directory tracker_10/migrations
python -B -m flask --app tracker_10 db init -d tracker_10/migrations

# Perform an initial migration to capture the current schema of the database
# If using older command syntax, uncomment below:
# python -B -m flask --app tracker_10 db migrate --message "Initial migration" --directory tracker_10/migrations
python -B -m flask --app tracker_10 db migrate -m "Initial migration" -d tracker_10/migrations
# For help with any of these commands, use python -B -m flask --app tracker_10 db --help
