...
def create_db():
    ...
    _roles = [
        ...
        Role(role_name='Associate', role_privilege='10'),
        Role(role_name='Teacher', role_privilege='20'),
        Role(role_name='Chair', role_privilege='30'),
    ]
    ...
    _associations = [
        Association(member_id='2', course_id='1', role_id='5'),
        Association(member_id='3', course_id='1', role_id='4'),
        Association(member_id='4', course_id='1', role_id='3'),
        Association(member_id='5', course_id='1', role_id='3'),
        Association(member_id='6', course_id='1', role_id='2'),
        Association(member_id='7', course_id='1', role_id='2'),
        Association(member_id='8', course_id='1', role_id='2'),
        Association(member_id='9', course_id='2', role_id='5'),
        Association(member_id='10', course_id='2', role_id='4'),
        Association(member_id='11', course_id='2', role_id='3'),
        Association(member_id='12', course_id='2', role_id='3'),
        Association(member_id='13', course_id='2', role_id='2'),
        Association(member_id='14', course_id='2', role_id='2'),
        Association(member_id='15', course_id='2', role_id='2'),
        Association(member_id='16', course_id='3', role_id='5'),
        Association(member_id='2', course_id='3', role_id='4'),
        Association(member_id='3', course_id='3', role_id='3'),
        Association(member_id='4', course_id='3', role_id='3'),
        Association(member_id='5', course_id='3', role_id='2'),
        Association(member_id='6', course_id='3', role_id='2'),
        Association(member_id='7', course_id='3', role_id='2'),
        Association(member_id='8', course_id='4', role_id='5'),
        Association(member_id='9', course_id='4', role_id='4'),
        Association(member_id='10', course_id='4', role_id='3'),
        Association(member_id='11', course_id='4', role_id='3'),
        Association(member_id='12', course_id='4', role_id='2'),
        Association(member_id='13', course_id='4', role_id='2'),
        Association(member_id='14', course_id='4', role_id='2'),
        Association(member_id='15', course_id='5', role_id='5'),
        Association(member_id='16', course_id='5', role_id='4'),
        Association(member_id='2', course_id='5', role_id='3'),
        Association(member_id='3', course_id='5', role_id='3'),
        Association(member_id='4', course_id='5', role_id='2'),
        Association(member_id='5', course_id='5', role_id='2'),
        Association(member_id='6', course_id='5', role_id='2'),
        Association(member_id='7', course_id='6', role_id='5'),
        Association(member_id='8', course_id='6', role_id='4'),
        Association(member_id='9', course_id='6', role_id='3'),
        Association(member_id='10', course_id='6', role_id='3'),
        Association(member_id='11', course_id='6', role_id='2'),
        Association(member_id='12', course_id='6', role_id='2'),
        Association(member_id='13', course_id='6', role_id='2'),
        Association(member_id='14', course_id='7', role_id='5'),
        Association(member_id='15', course_id='7', role_id='4'),
        Association(member_id='16', course_id='7', role_id='3'),
        Association(member_id='2', course_id='7', role_id='3'),
        Association(member_id='3', course_id='7', role_id='2'),
        Association(member_id='4', course_id='7', role_id='2'),
        Association(member_id='5', course_id='7', role_id='2'),
        Association(member_id='6', course_id='8', role_id='5'),
        Association(member_id='7', course_id='8', role_id='4'),
        Association(member_id='8', course_id='8', role_id='3'),
        Association(member_id='9', course_id='8', role_id='3'),
        Association(member_id='10', course_id='8', role_id='2'),
        Association(member_id='11', course_id='8', role_id='2'),
        Association(member_id='12', course_id='8', role_id='2'),
        Association(member_id='13', course_id='9', role_id='5'),
        Association(member_id='14', course_id='9', role_id='4'),
        Association(member_id='15', course_id='9', role_id='3'),
        Association(member_id='16', course_id='9', role_id='3'),
        Association(member_id='2', course_id='9', role_id='2'),
        Association(member_id='3', course_id='9', role_id='2'),
        Association(member_id='4', course_id='9', role_id='2'),
        Association(member_id='5', course_id='10', role_id='5'),
        Association(member_id='6', course_id='10', role_id='4'),
        Association(member_id='7', course_id='10', role_id='3'),
        Association(member_id='8', course_id='10', role_id='3'),
        Association(member_id='9', course_id='10', role_id='2'),
        Association(member_id='10', course_id='10', role_id='2'),
        Association(member_id='11', course_id='10', role_id='2'),
        Association(member_id='12', course_id='11', role_id='5'),
        Association(member_id='13', course_id='11', role_id='4'),
        Association(member_id='14', course_id='11', role_id='3'),
        Association(member_id='15', course_id='11', role_id='3'),
        Association(member_id='16', course_id='11', role_id='2'),
        Association(member_id='2', course_id='11', role_id='2'),
        Association(member_id='3', course_id='11', role_id='2'),
        Association(member_id='4', course_id='12', role_id='5'),
        Association(member_id='5', course_id='12', role_id='4'),
        Association(member_id='6', course_id='12', role_id='3'),
        Association(member_id='7', course_id='12', role_id='3'),
        Association(member_id='8', course_id='12', role_id='2'),
        Association(member_id='9', course_id='12', role_id='2'),
        Association(member_id='10', course_id='12', role_id='2'),
        Association(member_id='11', course_id='13', role_id='5'),
        Association(member_id='12', course_id='13', role_id='4'),
        Association(member_id='13', course_id='13', role_id='3'),
        Association(member_id='14', course_id='13', role_id='3'),
        Association(member_id='15', course_id='13', role_id='2'),
        Association(member_id='16', course_id='13', role_id='2'),
        Association(member_id='2', course_id='13', role_id='2'),
        Association(member_id='3', course_id='14', role_id='5'),
        Association(member_id='4', course_id='14', role_id='4'),
        Association(member_id='5', course_id='14', role_id='3'),
        Association(member_id='6', course_id='14', role_id='3'),
        Association(member_id='7', course_id='14', role_id='2'),
        Association(member_id='8', course_id='14', role_id='2'),
        Association(member_id='9', course_id='14', role_id='2'),
        Association(member_id='10', course_id='15', role_id='5'),
        Association(member_id='11', course_id='15', role_id='4'),
        Association(member_id='12', course_id='15', role_id='3'),
        Association(member_id='13', course_id='15', role_id='3'),
        Association(member_id='14', course_id='15', role_id='2'),
        Association(member_id='15', course_id='15', role_id='2'),
        Association(member_id='16', course_id='15', role_id='2'),
        Association(member_id='2', course_id='16', role_id='5'),
        Association(member_id='3', course_id='16', role_id='4'),
        Association(member_id='4', course_id='16', role_id='3'),
        Association(member_id='5', course_id='16', role_id='3'),
        Association(member_id='6', course_id='16', role_id='2'),
        Association(member_id='7', course_id='16', role_id='2'),
        Association(member_id='8', course_id='16', role_id='2'),
    ]
