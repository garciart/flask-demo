...
def create_db():
    ...
    _courses = [
        Course(course_name='Introductory Programming',
        ...
        Course(course_name='Intermediate Programming',
               course_code='CMSC 215', course_group='CMSC',
               course_desc='Further study of the Java programming language.'),
        Course(course_name='Relational Database Concepts and Applications',
        ...
        Course(course_name='Capstone in Computer Science',
        ...
        Course(course_name='Building Secure Python Applications',
        ...
        Course(course_name='Detecting Software Vulnerabilities',
        ...
        Course(course_name='Fundamentals of Networking',
        ...
        Course(course_name='Introduction to Linux',
               course_code='CMIT 291', course_group='CMIT',
               course_desc='A study of the Linux operating system.'),
        Course(course_name='Mathematics for Data Science',
        ...
        Course(course_name='Cybersecurity for Leaders and Managers',
        ...
        Course(course_name='Cybersecurity Processes and Technologies',
        ...
        Course(course_name='Cybersecurity in Business and Industry',
    ...
    _roles = [
        Role(role_name='Chair', role_privilege='3'),
        Role(role_name='Teacher', role_privilege='2'),
        ...
        # to save space
        # Role(role_name='Not Assigned', role_privilege='0')
    ]
    ...
    _associations = [
        Association(member_id='2', course_id='1', role_id='1'),
        Association(member_id='3', course_id='1', role_id='2'),
        Association(member_id='4', course_id='1', role_id='3'),
        Association(member_id='5', course_id='1', role_id='3'),
        Association(member_id='6', course_id='2', role_id='1'),
        Association(member_id='7', course_id='2', role_id='2'),
        Association(member_id='8', course_id='2', role_id='3'),
        Association(member_id='9', course_id='2', role_id='3'),
        Association(member_id='10', course_id='3', role_id='1'),
        Association(member_id='11', course_id='3', role_id='2'),
        Association(member_id='12', course_id='3', role_id='3'),
        Association(member_id='13', course_id='3', role_id='3'),
        Association(member_id='14', course_id='4', role_id='1'),
        Association(member_id='15', course_id='4', role_id='2'),
        Association(member_id='16', course_id='4', role_id='3'),
        Association(member_id='2', course_id='4', role_id='3'),
        Association(member_id='3', course_id='5', role_id='1'),
        Association(member_id='4', course_id='5', role_id='2'),
        Association(member_id='5', course_id='5', role_id='3'),
        Association(member_id='6', course_id='5', role_id='3'),
        Association(member_id='7', course_id='6', role_id='1'),
        Association(member_id='8', course_id='6', role_id='2'),
        Association(member_id='9', course_id='6', role_id='3'),
        Association(member_id='10', course_id='6', role_id='3'),
        Association(member_id='11', course_id='7', role_id='1'),
        Association(member_id='12', course_id='7', role_id='2'),
        Association(member_id='13', course_id='7', role_id='3'),
        Association(member_id='14', course_id='7', role_id='3'),
        Association(member_id='15', course_id='8', role_id='1'),
        Association(member_id='16', course_id='8', role_id='2'),
        Association(member_id='2', course_id='8', role_id='3'),
        Association(member_id='3', course_id='8', role_id='3'),
        Association(member_id='4', course_id='9', role_id='1'),
        Association(member_id='5', course_id='9', role_id='2'),
        Association(member_id='6', course_id='9', role_id='3'),
        Association(member_id='7', course_id='9', role_id='3'),
        Association(member_id='8', course_id='10', role_id='1'),
        Association(member_id='9', course_id='10', role_id='2'),
        Association(member_id='10', course_id='10', role_id='3'),
        Association(member_id='11', course_id='10', role_id='3'),
        Association(member_id='12', course_id='11', role_id='1'),
        Association(member_id='13', course_id='11', role_id='2'),
        Association(member_id='14', course_id='11', role_id='3'),
        Association(member_id='15', course_id='11', role_id='3'),
        Association(member_id='16', course_id='12', role_id='1'),
        Association(member_id='2', course_id='12', role_id='2'),
        Association(member_id='3', course_id='12', role_id='3'),
        Association(member_id='4', course_id='12', role_id='3'),
        Association(member_id='5', course_id='13', role_id='1'),
        Association(member_id='6', course_id='13', role_id='2'),
        Association(member_id='7', course_id='13', role_id='3'),
        Association(member_id='8', course_id='13', role_id='3'),
        Association(member_id='9', course_id='14', role_id='1'),
        Association(member_id='10', course_id='14', role_id='2'),
        Association(member_id='11', course_id='14', role_id='3'),
        Association(member_id='12', course_id='14', role_id='3'),
        Association(member_id='13', course_id='15', role_id='1'),
        Association(member_id='14', course_id='15', role_id='2'),
        Association(member_id='15', course_id='15', role_id='3'),
        Association(member_id='16', course_id='15', role_id='3'),
        Association(member_id='2', course_id='16', role_id='1'),
        Association(member_id='3', course_id='16', role_id='2'),
