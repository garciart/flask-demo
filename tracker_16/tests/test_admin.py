...
from tracker_16.blueprints.admin.admin_forms import EditMemberForm
...
class TestAdmin(BaseTestCase):
    ...
    # @patch('tracker_16.blueprints.admin.admin_forms.db.session.scalar')
    ...
    # @patch('tracker_16.blueprints.admin.admin_routes.EditMemberForm')
    # @patch('tracker_16.models.member.db.session.commit')
    ...
    #         'tracker_16.models.member.Member.query.get_or_404', return_value=mock_member
    #     ):
