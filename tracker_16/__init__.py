...
Usage: python -B -m flask --app tracker_16 run
"""
...
from tracker_16.app_utils import validate_input, check_system, start_log_file, log_page_request
# Import the runtime configuration classes
from tracker_16.config import CONFIGS
...
def create_app(config_name: str = 'default', log_events: Union[bool, None] = None) -> flask.Flask:
    ...
    from tracker_16.blueprints import main, error, admin, api, auth
